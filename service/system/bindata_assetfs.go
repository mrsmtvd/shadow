...
func templatesConfigTplHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/config.tpl.html", size: 648, mode: os.FileMode(420), modTime: time.Unix(1480104727, 0)}
...
func templatesLogsTplHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/logs.tpl.html", size: 2054, mode: os.FileMode(420), modTime: time.Unix(1480104727, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
