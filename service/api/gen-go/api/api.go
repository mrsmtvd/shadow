...
func (p *ApiClient) Ping() (r bool, err error) {
...
func (p *ApiClient) sendPing() (err error) {
...
func (p *ApiClient) recvPing() (value bool, err error) {
...
func NewApiProcessor(handler Api) *ApiProcessor {
	...
	self2 := &ApiProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["ping"] = &apiProcessorPing{handler: handler}
	return self2
}

func (p *ApiProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type apiProcessorPing struct {
	handler Api
}

func (p *apiProcessorPing) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := PingArgs{}
