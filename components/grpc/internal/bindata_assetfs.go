...
func templatesViewsManagerHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/views/manager.html", size: 8233, mode: os.FileMode(420), modTime: time.Unix(1507064833, 0)}
...
func assetsJsManagerMinJs() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/js/manager.min.js", size: 468, mode: os.FileMode(420), modTime: time.Unix(1507066411, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
