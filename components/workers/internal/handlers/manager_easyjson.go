...
func easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers(in *jlexer.Lexer, out *managerHandlerResponse) {
	...
	for !in.IsDelim('}') {
		...
		case "tasks_wait":
			if in.IsNull() {
				...
				if out.Tasks == nil {
					if !in.IsDelim(']') {
						out.Tasks = make([]managerHandlerResponseTask, 0, 1)
					} else {
						out.Tasks = []managerHandlerResponseTask{}
					}
				} else {
					out.Tasks = (out.Tasks)[:0]
				}
				for !in.IsDelim(']') {
					var v1 managerHandlerResponseTask
		...
		case "workers":
			if in.IsNull() {
				...
				if out.Workers == nil {
					if !in.IsDelim(']') {
						out.Workers = make([]managerHandlerResponseWorker, 0, 1)
					} else {
						out.Workers = []managerHandlerResponseWorker{}
					}
				} else {
					out.Workers = (out.Workers)[:0]
				}
				for !in.IsDelim(']') {
					var v2 managerHandlerResponseWorker
		...
		case "listeners":
			if in.IsNull() {
				...
				if out.Listeners == nil {
					if !in.IsDelim(']') {
						out.Listeners = make([]managerHandlerResponseListener, 0, 1)
					} else {
						out.Listeners = []managerHandlerResponseListener{}
					}
				} else {
					out.Listeners = (out.Listeners)[:0]
				}
				for !in.IsDelim(']') {
					var v3 managerHandlerResponseListener
...
func easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers(out *jwriter.Writer, in managerHandlerResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v managerHandlerResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
func (v managerHandlerResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *managerHandlerResponse) UnmarshalJSON(data []byte) error {
...
func (v *managerHandlerResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers(l, v)
}
func easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers1(in *jlexer.Lexer, out *managerHandlerResponseListener) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers1(out *jwriter.Writer, in managerHandlerResponseListener) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
// MarshalJSON supports json.Marshaler interface
func (v managerHandlerResponseListener) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v managerHandlerResponseListener) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers1(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *managerHandlerResponseListener) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *managerHandlerResponseListener) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers1(l, v)
}
func easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers2(in *jlexer.Lexer, out *managerHandlerResponseWorker) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "task":
			if in.IsNull() {
				...
				if out.Task == nil {
					out.Task = new(managerHandlerResponseTask)
				}
...
func easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers2(out *jwriter.Writer, in managerHandlerResponseWorker) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
// MarshalJSON supports json.Marshaler interface
func (v managerHandlerResponseWorker) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v managerHandlerResponseWorker) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers2(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *managerHandlerResponseWorker) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *managerHandlerResponseWorker) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers2(l, v)
}
func easyjsonEd74d837DecodeGithubComKihamoShadowComponentsWorkersInternalHandlers3(in *jlexer.Lexer, out *managerHandlerResponseTask) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers3(out *jwriter.Writer, in managerHandlerResponseTask) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
// MarshalJSON supports json.Marshaler interface
func (v managerHandlerResponseTask) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v managerHandlerResponseTask) MarshalEasyJSON(w *jwriter.Writer) {
	easyjsonEd74d837EncodeGithubComKihamoShadowComponentsWorkersInternalHandlers3(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *managerHandlerResponseTask) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *managerHandlerResponseTask) UnmarshalEasyJSON(l *jlexer.Lexer) {
