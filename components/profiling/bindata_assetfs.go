...
func templatesViewsTraceHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/views/trace.html", size: 4927, mode: os.FileMode(420), modTime: time.Unix(1487596072, 0)}
