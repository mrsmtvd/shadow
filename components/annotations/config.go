...
const (
	ConfigStorageGrafanaEnabled    = ComponentName + ".storage.grafana.enabled"
	ConfigStorageGrafanaAddress    = ComponentName + ".storage.grafana.address"
	ConfigStorageGrafanaApiKey     = ComponentName + ".storage.grafana.api-key"
