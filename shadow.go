...
//go:generate sh -c "cd components/profiling && go-bindata-assetfs -pkg=profiling templates/... public/..."
//go:generate sh -c "cd components/workers && go-bindata-assetfs -pkg=workers templates/..."
//go:generate easyjson components/alerts/handler_ajax.go
//go:generate easyjson components/workers/handler_ajax.go
